...
function doStat ($table, $entity, $header, $level=0) {
   ...
   $criteria = [
      ...
      + getEntitiesRestrictCriteria($table, '', getSonsOf('glpi_entities',$entity))
  ];
...
Session::checkRight("plugin_reports_tudcomputerbyentity", READ);
//TRANS: The name of the report = Number of items by entity
Html::header(__('tudcomputerbyentity_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
